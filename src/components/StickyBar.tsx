...
export default function StickyBar() {
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-50 flex items-center gap-2 px-4 py-3 border-t"
      style={{
    ...
    >
      <a
        ...
        className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl font-semibold text-sm text-white transition-opacity hover:opacity-90 active:opacity-80"
      ...
      <a
        href="#menu"
        className="flex items-center justify-center px-5 py-3 rounded-xl text-sm font-semibold border transition-colors hover:bg-[#E87722]/10"
