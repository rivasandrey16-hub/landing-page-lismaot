...
export default function StickyBar({ totalItems, onOpenCart }: Props) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5 max-w-lg mx-auto">
        {hasItems ? (
          /* Cart has items — primary CTA opens the cart with formatted order */
          <button
            onClick={onOpenCart}
            className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-[14px] transition-all hover:brightness-110 active:scale-[0.98]"
            style={{
          ...
          >
            ...
            Ver pedido ({totalItems}) · Enviar por WhatsApp
          </button>
        ) : (
          /* Empty cart — generic greeting link */
          <a
            href={WA_LINK}
            target="_blank"
